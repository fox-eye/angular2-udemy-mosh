System.register(['angular2/core', 'angular2/router', 'angular2/http', './photo.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, http_1, photo_service_1;
    var AlbumsComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AlbumsComponent = (function () {
                ...
                AlbumsComponent = __decorate([
                    core_1.Component({
                        template: "\n        <h1>Albums</h1>\n        <div *ngIf=\"isLoading\">\n            <i class=\"fa fa-spinner fa-spin fa-3x\"></i>\n        </div>\n        <ul>\n            <li *ngFor=\"#album of albums\">\n              <a [routerLink]=\"['Album', { id: album.id }]\">{{ album.title }}\n              </a>           \n            </li> \n        </ul>\n    ",
